...
I am an IEEE Senior member. Currently, I serve as an associate editor of [Neurocomputing](https://www.journals.elsevier.com/neurocomputing) and [Visual Computer](https://link.springer.com/journal/371) and a young associate editor in [Journal of Computer Research and Development](https://crad.ict.ac.cn)(CRAD, 计算机研究与发展in Chinese) and [Journal of image and Graphics](http://www.cjig.cn/jig/ch/index.aspx) (JIG, 中国图象图形学报 in Chinese) and an active reviewer for several international journals  (including IEEE T-PAMI, IJCV, IEEE T-NNLS, IEEE T-IP, IEEE T-MM, Neurocomputing) and conferences (including ECCV 2024, CVPR 2024, CVPR 2023, CVPR 2022, CVPR 2021, ECCV 2020, AAAI 2021, AAAI 2020, PRCV 2020, ICCV 2019, etc).
...
[中文主页](https://informatics.xmu.edu.cn/info/1284/23659.htm)
...
- Yuanling Lv, **Yan Yan***, Jing-Hao Xue, Si Chen, Hanzi Wang. Relationship-Guided Knowledge Transfer for Class-Incremental Facial Expression Recognition. IEEE Transactions on Image Processing (IEEE T-IP), 2024.
- Xiao Wang, **Yan Yan**, Hai-Miao Hu, Bo Li, Hanzi Wang, Cross-Modal Contrastive Learning Network for Few-Shot Action Recognition. IEEE Transactions on Image Processing (IEEE T-IP), 33: 1257-1271, 2024. [link](https://ieeexplore.ieee.org/document/10411850?source=authoralert)
##### Conference
